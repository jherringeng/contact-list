<?php
  ...
  $name = $_REQUEST['name']; $location = $_REQUEST['location'];

  $query = "INSERT INTO department (name, locationID) VALUES ('$name', '$location')";
  ...
  $output['data']['departments'] = $data;
	...
	$query = "SELECT d.id, d.name, d.locationID, l.name as location, l.shortName as locationShort FROM department d LEFT JOIN location l ON (l.id = d.locationID) WHERE d.id = $last_id";
