<?php
	...
	$employeeID = $_REQUEST['employeeID']; $departmentID = $_REQUEST['departmentID']; $departmentName = $_REQUEST['departmentName'];

	$query = "UPDATE department SET managerID='$employeeID' WHERE id='$departmentID'";
	$result = $conn->query($query);

	$query = "UPDATE personnel SET departmentID='$departmentID', jobTitle='Head of $departmentName' WHERE id='$employeeID'";
	$result = $conn->query($query);
